...
- The code from `gen3sis` were reworked removing the dependencies from
  `raster`.
- Cost function syntax were simplified and enhanced.
- Distance matrices calculation is now implemented with a dedicated
  function.
- Distance matrices cam now be asymmetrical.
- `gen3sis` landscapes.rds were replaced by spaces.rds, an enhanced
  version with three types:
  - raster
  - H3
  - points

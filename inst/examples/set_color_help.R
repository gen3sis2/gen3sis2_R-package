...
vals <- c(1,2,3,4,5)
plot(1:5, vals, col=set_color(vals, color_richness, "navajowhite3"), pch=15, cex=2)
# set color scale, zero values present!
vals <- c(0,2,3,4,5)
plot(1:5, vals, col=set_color(vals, color_richness_CVDCBP, "navajowhite3"), pch=15, cex=2)

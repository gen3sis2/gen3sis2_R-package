...
Some terms and names of `gen3sis2` should be maintained and ambiguation should be avoided.
Below is a comprehensive list of these, followed by its definition.

...
The `main` branch contains a running and tested version of the code
base. All development happens on shorter lived feature branches and will
be merged onto the main branch by pull request and only after successful
checks and reviews. Name the branches with a meaningful name. Releases,

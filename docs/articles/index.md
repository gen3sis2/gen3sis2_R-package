...
- [2. Creating spaces: the basics (gen3sis2
  input)](a-create-input-space.md):
- [2.1 Creating spaces: cost functions and matrices
  symmetry](b-cost-functions-mtx-symmetry.md):

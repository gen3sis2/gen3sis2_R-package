...
area_5 <- rasterFromXYZ(spaces$env$area[, c(1,2,3)])
area_0 <- rasterFromXYZ(spaces$env$area[, c(1,2,8)]) 
arid_5 <- rasterFromXYZ(spaces$env$arid[, c(1,2,3)])
arid_0 <- rasterFromXYZ(spaces$env$arid[, c(1,2,8)]) 
